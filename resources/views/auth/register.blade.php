        ...
        <div class="container-fluid text-center mx-auto" >
            <div class="row login">
                <div class="left-container col-sm-12 col-md-6 d-lg-flex justify-content-center flex-lg-column p-4 d-none d-sm-block"> 
                    ...
                    <h1 class="short-title">Learn Your Way to Investment. Increase Your Financial Literacy. </h1>
                    <p class="short-title-desc">Get the most suitable financial education material & content tailored for you</p>
                </div>
                    ...
                    <div class="container-fluid text-center mx-auto" style="min-height:100vh">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="phoneNumber" class="form-control" type="text" name="phoneNumber" value="{{ old('phoneNumber') }}" required autocomplete="username" />
