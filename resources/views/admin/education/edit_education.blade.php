                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="addEducationForm" action="{{ route('update.education') }}" method="POST"
                                    ...
                                    <div class="col-sm-10">
                                        <select name="educationCategory" class="form-select"
                                            ...
                                            @foreach ($educationCategories as $item)
                                                <option value="{{ $item->id }}" {{ $item->id == $item->id ? 'selected' : '' }}>{{ $item->educationCategory }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="educationTitle" type="text" placeholder="Title"
                                            id="example-text-input" value="{{$education->educationTitle}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="educationAuthor" type="text"
                                            placeholder="Author" id="example-text-input" value="{{$education->educationAuthor}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="educationPrice" type="number" placeholder="Price"
                                            id="example-text-input" value="{{$education->educationPrice}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="educationShortDesc" type="text"
                                            placeholder="Short Description" id="example-text-input" value="{{$education->educationShortDesc}}">
                                ...
                                {{-- Education Image  --}}
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Education Thumbnail 
                                        <br> 
                                        <small class="text-danger fw-light">*Choose if you want to update thumbnail</small> 
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" style="width: 128px" class="rounded avatar-lg"
                                            src="{{ asset($education->educationThumbnail) }}" alt="Card image cap">
                                    </div>
                                ...
                                {{-- Education Video --}}
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="educationVideo">Select Education Video 
                                        <br> 
                                        <small class="text-danger fw-light">*Choose if you want to update Video</small> 
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <input type="submit" class="btn btn-info waves-effect waves-light" id="submitBtn"
                                    value="Update Education Data" onclick="showLoading()">
                            </form>
                        </div>
                    </div>
                </div> <!-- end col -->
