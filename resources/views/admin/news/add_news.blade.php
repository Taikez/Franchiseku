                        ...
                        <form action="{{route('post.news')}}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="row mb-3">
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="newsTitle" type="text" placeholder="Title" id="example-text-input">
                                    @error('newsTitle')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="newsAuthor" type="text" placeholder="Author" id="example-text-input">
                                    @error('newsAuthor')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror 
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="newsTags" value="Franchise,Investing" type="text" data-role="tagsinput" id="example-text-input">
                                </div>
                            </div>
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="newsImage" type="file" placeholder="News Image" id="image" >
                                    @error('newsImage')
                                       <span class="text-danger">{{$message}}</span>
                                   @enderror 
                                </div>
                            ...
                            <input type="submit" class="btn btn-info waves-effect waves-light" id="submitBtn" value="Insert News Data">
