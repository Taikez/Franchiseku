                ...
                <div class="container mt-5 mb-5 p-4 rounded contact-us-div">
                  <div class="row d-flex align-items-center">
                    <div class="col-md-6 mx-auto d-flex flex-column justify-content-between p-4" style="height: 35vh;">
                      <h1 class="fs-3 fw-normal text-light">Have a question or need assistance? Reach Out to Our Admin Team</h1>
                      <p class="fs-5 fw-light">Your inquiries are important to us, and we're here to help. Send us a message today!"</p>
                    </div>
                    ...
                    <div class="col-md-6">
                      <form method="POST" action="">
                       ...
                       <div class="mb-3 mt-4 d-flex justify-content-end">
                         <button type="submit" class="submitBtn fs-5" style="padding: .25rem 1rem; border-radius:5px;">Send Message</button>
                       </div>
                      </form>
                    </div>
