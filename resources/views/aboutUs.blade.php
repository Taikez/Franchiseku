...
@section('main')
        ...
        <div class="row">
            <div id="header-left" class="col-lg-6 col-md-6 col-sm-12 p-5 d-flex align-items-center">
                <div id="extra-padding" class="p-5" style="margin-left: 10rem;">
                    <h1 class="mb-5 fw-bolder" style="font-size: 55px;">About <br> FranchiseKu</h1>
                    <div id="header-text" class="w-75">
                        <p class="fs-5 lh-base">Who are we? welcome to FranchiseKu, the premier franchise investment app
                            designed to help you make well-knowledged decisions about your financial future.</p>

                        <p class="fs-5 lh-base">Our platform is built with the latest technology and investment insights to
    ...
    <div id="our-products" class="container-fluid mt-5"
        ...
        <div id="our-products-text" class="row d-flex justify-content-center align-items-center text-center mt-5">
            <h1 class="fw-bolder p-5 mt-5">Our Products</h1>
        </div>

        <div id="offers" class="row d-flex justify-content-center align-items-center p-5 me-5 lh-lg">
            <div id="offer-1" class="col-lg-4 col-md-12 col-sm-12 text-center">
            ...
            <div id="offer-2" class="col-lg-4 col-md-12 col-sm-12 text-center">
            ...
            <div id="offer-3" class="col-lg-4 col-md-12 col-sm-12 text-center">
