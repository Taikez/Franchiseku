        ...
        <div class="container-fluid text-center mx-auto" >
            <div class="row login">
                <div class="left-container col-sm-12 col-md-6 d-lg-flex justify-content-center flex-lg-column p-4 d-none d-sm-block"> 
                    ...
                    <h1 class="short-title text-start lh-base fs-2">Build Your Future. <br> Plan Better. <br> Organize Better.</h1>
                    <p class="short-title-desc">Get the most suitable franchise investment with the correct knowledge and category suited for you</p>
                </div>
                ...
                <div class="right-container col-sm-12 col-md-6 bg-light p-4">
                    ...
                    <div class="container-fluid text-center mx-auto" style="min-height:100vh; margin: 0 0 ;">
                        ...
                        <div class="mb-4">
                                <img src="{{ asset('authImg/franchiseku_logo.png') }}" class="z-full p-4" style="width: 60%" alt="">
                        ...
                        <form method="POST" class="bg-white rounded p-4" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" class="form-control" type="email" name="email" placeholder="Enter your email" value="{{ old('email') }}" required autofocus autocomplete="username">
                            ...
                            <div class="mb-3 text-start">
                                @if (Route::has('password.request'))
                                    <a class="text-sm text-success fw-bold text-decoration-none" href="{{ route('password.request') }}">
