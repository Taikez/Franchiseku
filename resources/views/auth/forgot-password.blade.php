            ...
            <div class="container-fluid text-center mx-auto">
                <div class="row login">
                    <div class="left-container col-sm-12 col-md-6 d-lg-flex justify-content-center flex-lg-column p-4 d-none d-sm-block"
                        ...
                        <p class="short-title-desc" data-aos="fade-right" data-aos-duration="800">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</p>
                    </div>
                    <div class="right-container col-sm-12 col-md-6 bg-light p-4">
                        <div class="container-fluid text-center mx-auto" style="min-height:100vh; margin: 0 0 ;">
                            ...
                            <!-- Session Status -->
                            <form method="POST" class="bg-white rounded p-4" action="{{ route('password.email') }}"
